...
const HeroAboutSection: React.FC<HeroAboutSectionProps> = ({
  ...
  mainTextPart1 = "Being a wedding planner allows us to get",
  creativeText = "creative",
  mainTextPart2 = ", make dreams come true and witness blissful moments of our couples.",
}) => {
  return (
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center items-end">
        ...
        */}
        <div className="bg-[#f9f5ef] text-center p-8 sm:p-10 md:p-12 lg:p-16 shadow-xl w-full max-w-3xl xl:max-w-4xl
                        lg:mb-[-10%] xl:mb-[-15%] relative z-10 mx-4 sm:mx-auto"> {/* Thêm mx-4 sm:mx-auto */}
          {sectionTitle && (
            <p className="text-xs text-gray-500 uppercase tracking-wider mb-6 sm:mb-8">
              {sectionTitle}
            </p>
          )}
          <p className="font-serif text-xl sm:text-2xl md:text-3xl text-gray-700 leading-relaxed">
            {mainTextPart1}{' '}
            <span className="font-script text-4xl sm:text-5xl md:text-6xl text-gray-800">
              {creativeText}
            </span>
            {mainTextPart2}
          </p>
